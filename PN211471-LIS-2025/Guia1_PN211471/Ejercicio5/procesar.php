...
extract($_POST);
$cliente = !empty($client) ? $client : "<a href='ingresosdatos.html' class='text-danger'>No ingresó
el cliente.</a>";
echo "\t\t<td>" . $cliente . "</td>\n";
echo "\t</tr>\n";
echo "\t<tr>\n";
echo "\t\t<td>Producto</td>\n";
$producto = !empty($product) ? $product : "<a href='ingresosdatos.html' class='text-danger'>No
ingresó el producto.</a>";
echo "\t\t<td>" . $producto . "</td>\n";
echo "\t</tr>\n";
echo "\t<tr>\n";
echo "\t\t<td>Precio</td>\n";
$precio = !empty($price) ? $price : "<a href='ingresosdatos.html' class='text-danger'>No ingresó
el precio</a>";
echo "\t\t<td>" . $precio . "</td>\n";
echo "\t</tr>\n";
echo "\t<tr>\n";
echo "\t\t<td>Cantidad</td>\n";
$cantidad = !empty($quantity) ? $quantity : "<a href='ingresosdatos.html' class='text-danger'>No
